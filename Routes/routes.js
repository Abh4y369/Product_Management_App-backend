...
router.get('/category/all',categoryControllers.getAllCategories)


//sub category
router.post('/subcategory/add',jwtMiddle,subCategoryControllers.addSubcategory)
router.get('/subcategory/all',subCategoryControllers.getAllSubCategories)

//products
router.post('/product/add',jwtMiddle,multerConfig.single('image'),productControllers.addProduct)
router.get('/product/all',productControllers.getAllProducts)
router.get('/product/:pid',productControllers.getProductById)
